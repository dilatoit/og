...
- Add an 'Order' tab (node/%/order) to a book's main page node.

- Remove the 'Outline' tab from all nodes.

- Remove the book fieldset from node edit pages if the content type does not
  allowed book outlines.

- Remove 'add child page' and 'printer-friendly version'

- Remove book navigation

- Customize visibility of a book's navigation elements.
...
- Disable new revisions from being created when a book's node title is updated.
